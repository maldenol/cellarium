...
static constexpr float kInitChildBudMutationChance         = 0.25f;
static constexpr float kInitParentBudMutationChance        = 0.25f;
...
class CellController {
 public:
  ...
  struct Params {
    ...
    float childBudMutationChance{kInitChildBudMutationChance};
    float parentBudMutationChance{kInitParentBudMutationChance};
 ...
 private:
  ...
  float _childBudMutationChance{};
  float _parentBudMutationChance{};
